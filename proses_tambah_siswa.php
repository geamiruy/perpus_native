...
if ($_POST) {
    ...
    if (empty($nama_siswa)) {
        ...
        include "koneksi.php";
        $insert = mysqli_query($konek, "insert into siswa (nama_siswa,tanggal_lahir, gender, alamat, username, password, id_kelas) value ('" . $nama_siswa . "','" . $tanggal_lahir . "','" . $gender . "','" . $alamat . "','" . $username . "','" . md5($password) . "','" . $id_kelas . "')") or die(mysqli_error($konek));
        if ($insert) {
